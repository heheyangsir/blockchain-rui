    ...
    <main class="flex-1 overflow-y-auto pt-24 pb-16">
      <div class="max-w-5xl w-full mx-auto px-6 space-y-10">
        ...
        <section v-if="targetCredential"
          class="bg-white p-8 rounded-2xl shadow-xl border border-gray-200 space-y-4 text-sm">
        ...
        <p v-if="success" class="bg-green-100 text-green-700 p-4 rounded-lg text-sm text-center shadow">
          ✅ {{ success }}
        </p>
      </div>
    </main>
